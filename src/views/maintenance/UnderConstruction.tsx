...
// ASSETS
const construction = withBasePath('/assets/images/maintenance/img-cunstruct-1.svg');
const constructionBg = withBasePath('/assets/images/maintenance/img-cunstruct-1-bg.png');
const constructionbottom = withBasePath('/assets/images/maintenance/img-cunstruct-1-bottom.svg');
